...
# def link_DL(Link,Name="Audio_file"):
#   """
#   Download a link and saves to a given name
#   """
#   bashCommand = f"axel -n 16 {Link} >> {Name}.mp3"
...
def sendMessage(text='Task Finished'):
  token = '2091887944:AAHfm33MJliKl9n54SGIIDMDHys5Jqe49k8'
  data = {'chat_id': '-1001517547778', 'text': text,'parse_mode': 'HTML'}
  url = f'https://api.telegram.org/bot{token}/sendMessage'
  response = requests.get(url, params=data)
  return response.json()

def sendAudio(doc,text=f"""✅ Link Der Kannale : @BeataVideos
✅ Link Der Gruppe : <u><b><i><a href='https://t.me/+y7-l2vGlTFQ2Njg0'>Link</a></i></b></u>""",chat_id='-1001517547778'):
...
def sendImage(doc,name,link, chat_id='-1001517547778'):
    ...
    if download_link:
        ...
        if int(duration_secs/60) < 40:
            ...
            if file_size < 20:
                ...
                today=print(f"{datetime.today().year}/{datetime.today().month}/{datetime.today().day}")
                print(today)
                ...
                for div in range(division_parts):
                    ...
                    text=f"""<u><b><i><a href='{link}'>{Name_Only}</a></i></b></u>
✅ Link Der Kannale : @BeataVideos
✅ Link Der Gruppe : <u><b><i><a href='https://t.me/+y7-l2vGlTFQ2Njg0'>Link</a></i></b></u>"""
